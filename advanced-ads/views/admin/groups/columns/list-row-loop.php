...
<div class="advads-ad-group-list-ads">
	<?php
	foreach ( $group_ads as $ad ) :
		$ad_weight_percentage = '';
		?>
		<div style="<?php echo $counter > 3 ? 'display: none' : ''; ?>">
			<div class="advads-ad-group-list-ad-title">
			...
			<?php
			if ( $group->is_type( 'default' ) && $weight_sum ) :
				...
				?>
			<div class="advads-ad-group-list-ad-weight">
